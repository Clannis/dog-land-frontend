...
class Register extends Component {
    constructor(props) {
        super(props)
        this.state = {
            email: this.props.location.registerProps ? this.props.location.registerProps.email : "",
            password: this.props.location.registerProps ? this.props.location.registerProps.password : "",
